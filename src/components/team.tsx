                ...
                <div className="row ">
                    <div className="col-lg-8 offset-lg-2">
                        <div className="section-title text-center">
                            <h2>
                                {teamData.titleFitness} <span>{teamData.titleCoaches}</span>
                            </h2>
                            <p>{teamData.desc}</p>
                        </div>
                    </div>
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 team-container mb-3" key={index}>
                                <div className="team-box effect-item mt-40">
                                    <div className="team-item ">
                                        <ul>
                                            <ImageGallery imageList={imageList.filter((image: { name: string }) => image.name === teamMember.imageSrc,)} />
                                        </ul>
                                        <div className="content-details fadeIn-top">
                                            <ul>
                                                {teamMember.socialLinks.map((socialLink, linkIndex) => (
                                                    <li key={linkIndex}>
                                                        <a href={socialLink.link}>  <FontAwesomeIcon icon={iconMapping[socialLink.icon]} />   </a>
                                                    </li>
                                                ))}
                                            </ul>
