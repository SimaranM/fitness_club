            ...
            <Swiper
                ...
                <SwiperSlide>
                    <div className="slider">
                        <StaticImage
                            src="https://html.tonatheme.com/2020/fitnastic/images/main-slider/2.jpg"
                            ...
                            <div className="row">
                                <div className="col-xl-8 col-lg-10">
                                    <div className="slider-content-3">
                                        ...
                                        <h2>
                                            {" "}
                                            Making Different From Other Builds
                                            Health{" "}
                                        </h2>
                                        <p>
                                            {" "}
                                            Best GYM &amp; Fitness Center Build
                                            Your Health{" "}
                                        </p>
                                        <a
                                            href="#"
                                            className="read-more fadeInUp animated">
                                            {" "}
                                            Get started{" "}
                                            <FontAwesomeIcon
                                                icon={faChevronRight}
                ...
                <SwiperSlide>
                    <div className="slider">
                        <StaticImage
                            src="https://html.tonatheme.com/2020/fitnastic/images/main-slider/3.jpg"
                            className="swiper-slide"
                            alt="Banner"
                            style={{ width: "100%", height: "100%" }}
                        />
