...
const Contact: React.FC = () => {
    ...
    const formInputs: FormInput[] = data.allContactJson.nodes[0].formInputs;
                        ...
                        <div className="col-xl-4 col-lg-5">
                            <div className="contact-page-left">
                                ...
                                <div className="contact-page-social d-flex mt-5 mb-3">
                                    {contactData.contactUs.map((icon: { link: string; icon: string }, index: number) => (
                                    ...
                                    <form action="" className="contact-page-form">
                                        ...
                                        <div className="col-xl-12">
                                            <div className="contact-page-form-input-box mb-4">
                                                <textarea className="w-100 h-100 fs-6 ps-3 pb-5 pt-3 d-block" name={contactData.formTextArea.name}
                                                    placeholder={contactData.formTextArea.placeholder}></textarea>
                                            </div>
